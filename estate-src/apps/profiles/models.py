...
class Profile(TimeStampedUUIDModel):
    ...
    country = CountryField(verbose_name=_("Country"), default="PL",
                           blank=False, null=False)
    city = models.CharField(verbose_name=_("City"), max_length=180,
                            default="Radom", null=False, blank=False)
    ...
    rating = models.DecimalField(max_digits=4, decimal_places=2, null=True,
                                 blank=True)
    num_reviews = models.IntegerField(verbose_name=_("Numbers of reviews"), default=0,
